...
%% ----------------------------- Ground stations ----------------------------
% Station 1: Mexicali
gs(1).lat_deg = 32.6333;
gs(1).lon_deg = -117;
gs(1).alt_m   = 0;

% Station 2: Tijuana
gs(2).lat_deg = 32.5500;
gs(2).lon_deg = -116.9667;
gs(2).alt_m   = 0;
...
t_real        = cell(2,1);
idx_real      = cell(2,1);
measStartTime(1) = datetime(2026,6,1,1,29,50,'TimeZone','UTC','Locale','en_US');
...
% satdata_err.xmo    = 5.5492889041322;
% satdata_err.xnodeo = 3.01798247854471;
% satdata_err.omegao = 0.74570535577748;
% satdata_err.xincl  = 1.72697221158816;
% satdata_err.eo     = 0.00113925105043313;
% satdata_err.xno    = 0.0622633088464693;
% satdata_err.bstar  = 0.000165691721480952;
