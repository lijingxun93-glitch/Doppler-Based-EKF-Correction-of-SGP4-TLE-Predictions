clear;
measured_data_1 = readtable('C:\Users\22743\Desktop\Master project\satellite data\TERRA 20260720\epoch 20260327 SGP4_Az_El_Doppler_Visible.csv');
measured_data_2 = readtable('C:\Users\22743\Desktop\Master project\satellite data\TERRA 20260720\epoch 20260719 SGP4_Az_El_Doppler_Visible.csv');
% AWGN
sigma_D = 10;
rng(1);
...
legend('TLE epoch at 2026-03-27', 'TLE epoch at 2026-07-19');
hold off;
...
startTime = datetime(2026,7,20,4,12,19);
...
legend('TLE epoch at 2026-03-27', 'TLE epoch at 2026-07-19', 'Location','best'); 
title('Doppler shifts');
grid on; 
ylabel('Doppler (Hz)');
hold off;
