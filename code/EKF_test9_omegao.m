...
satdata_err.omegao = satdata.omegao + deg2rad(2);    % Argument of Perigee
%% ===================== Read EOP =====================
...
title(sprintf('Doppler Error (RMSE = %.3f Hz)', rmse_doppler));
yline(0,'--');
...
title(sprintf('Azimuth Error (RMSE = %.3f deg)', rmse_azimuth));
yline(0,'--');
...
title(sprintf('Elevation Error (RMSE = %.3f deg)', rmse_elevation));
yline(0,'--');
