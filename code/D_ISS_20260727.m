clear;
measured_data_1 = readtable('C:\Users\22743\Desktop\Master project\satellite data\ISS 20260727\epoch 20260519 SGP4_Az_El_Doppler_Visible.csv');
measured_data_2 = readtable('C:\Users\22743\Desktop\Master project\satellite data\ISS 20260727\epoch 20260727 SGP4_Az_El_Doppler_Visible.csv');
% AWGN
sigma_D = 10;
rng(1);
...
legend('TLE epoch at 2026-05-16', 'TLE epoch at 2026-07-27');
hold off;
...
legend('TLE epoch at 2026-05-16', 'TLE epoch at 2026-07-27', 'Location','best'); 
title('Doppler shifts');
grid on; 
ylabel('Doppler (Hz)');
hold off;
